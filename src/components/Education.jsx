  ...
  const educationData = [
    {
      ...
      mascot: "📘",
      achievements: ["Percentage: 76%", "Specialization: Science"],
      duration: "2016 - 2017", // Added duration for SSC
    },
    {
      degree: "Higher Secondary Certificate (HSC) - 12th Grade",
      school: "Rattan Convent School",
      mascot: "📗",
      achievements: ["Percentage: 78%", "Specialization: Science"],
      duration: "2018 - 2019", // Added duration for HSC
    },
    {
      degree: "Bachelor of Technology (B.Tech)",
      school: "National Institute of Technology (NIT) Kurukshetra",
      mascot: "🎓",
      achievements: [
        "CGPA: 7.68",
        "Major: Electronics & Communication Engineering",
      ],
      duration: "2020 - 2024", // Added duration for B.Tech
    },
  ];
