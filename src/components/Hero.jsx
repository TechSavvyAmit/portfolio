...
public:
    string name = "Amit";
    string title = "Full-Stack Developer | Tech Enthusiast | Problem Solver";
    vector<string> skills = {
        "React", "NextJS", "Redux", "Express",
        "MySQL", "MongoDB",  "TypeScript", "GraphQL",
        "Git", "Linux", "Python", "C++", "Java",
        "Machine Learning",
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-6 sm:mb-8">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight">
                  ...
                  <span className="relative inline-block">
                    I'm
                    <span className="typing-effect gradient-text"> Amit</span>
                  </span>
                </h1>
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Passionate about solving complex problems with clean and
                  efficient code 💻 | Creator of innovative solutions like
                  FitHub and Chess Master 🚀 | DSA enthusiast 🤓 | Embracing
                  OOPs and latest technologies 🌐 | Always learning, always
                  evolving ✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1pmlQZj93KnhRfzb_EIBpZyntjNn8qoXS/view?usp=sharing"
              ...
              <div className="mt-8 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  ...
                  <a
                    href="https://github.com/TechSavvyAmit"
                    className="group flex items-center justify-center gap-2 p-3 bg-gradient-to-r from-gray-800 to-gray-600 rounded-lg shadow transition-transform duration-300 hover:scale-105"
                  >
                  ...
                  <a
                    ...
                    className="group flex items-center justify-center gap-2 p-3 bg-gradient-to-r from-blue-700 to-blue-500 rounded-lg shadow transition-transform duration-300 hover:scale-105"
                  >
                  ...
                  <a
                    ...
                    className="group flex items-center justify-center gap-2 p-3 bg-gradient-to-r from-pink-500 to-yellow-400 rounded-lg shadow transition-transform duration-300 hover:scale-105"
                  >
                  ...
                  <a
                    ...
                    className="group flex items-center justify-center gap-2 p-3 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-lg shadow transition-transform duration-300 hover:scale-105"
                  >
